...
def procesar_geometrias():
    ...
    output_file = 'public/barrios.geojson'
    ...
    try:
        ...
        columnas_nombres = [c for c in gdf.columns if any(p in c.upper() for p in ['NOMBRE_BARRIO', 'BARRIO', 'NBR', 'NAME', 'BAR', 'NOM'])]
        ...
        print("\n✅ ¡TODO LISTO!")
        print(f"Ahora verás un archivo llamado 'barrios.geojson' dentro de la carpeta 'public'.")
